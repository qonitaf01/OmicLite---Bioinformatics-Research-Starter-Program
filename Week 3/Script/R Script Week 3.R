#Modul: Analisis Ekspresi Gen Respon Vaksin Flu 
...
#antara dua kondisi biologis (sebelum vs sesudah vaksinasi) 
...
#illuminaHumanv4.db: database anotasi khusus untuk chip Illumina (GSE48108)
...
#p.value = 0.05  -> gen signifikan untuk standar vaksin yang biasanya 0.05
...
#Penting:
#Pada data microarray Illumina, unit analisis awal adalah PROBE ID,
#bukan gen. Oleh karena itu, anotasi ulang diperlukan menggunakan
#database resmi Bioconductor (illuminaHumanv4.db).
